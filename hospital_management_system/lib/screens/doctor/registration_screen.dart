...
class _RegistrationScreenState extends State<DoctorRegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final genderField = TextFormField(
        ...
        validator: (value) {
          if (value!.isEmpty) {
            return ("Geneder cannot be Empty");
          }
          return null;
        },
        onSaved: (value) {
...
//phone number field
  ...
  postDetailsToFirestore() async {
    ...
    await firebaseFirestore.collection("doctors").doc(doctor.uid).set({
      'gender': genderEditingController.text,
      'phoneNumber':phoneNumberEditingController.text ,
      'qualification': qualificationEditingController.text,
